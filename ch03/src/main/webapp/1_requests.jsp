...
<html>
	<head>
		...
		request 내장객체
			- 클라이언트의 요청 정보를 갖는 JSP 내장 객체
			- 클라이언트의 전송 데이터를 수신처리하는 기능 제공
			
			
			GET 요청
			- 기본 데이터 요청 방식, 전송 데이터를 쿼리 스트링으로 전송(URL주소에 붙여 전송)
	...
	<body>
		...
		<a href="./proc/result1.jsp?uid=a101&name=홍길동">요청2</a>
		...
		<form action="./proc/result3.jsp" method="POST">
			<table border="1">
				...
				<tr>
					<td>취미</td>
					<td>
						<input type="checkbox" name = "hobby" value ="등산"/>등산</label>
						<input type="checkbox" name = "hobby" value ="게임"/>게임</label>
						<input type="checkbox" name = "hobby" value ="여행"/>여행</label>
						<input type="checkbox" name = "hobby" value ="독서"/>독서</label>
						<input type="checkbox" name = "hobby" value ="게임"/>게임</label>
					</td>
				</tr>
				<tr>
